    ...
    try {
      ...
      if (mounted) {
        ...
        setState(() {
          ...
          _todayAppointments = rawToday.take(5).toList();
          _todayCountTotal = rawToday.length;
          _completedTodayCount =
              rawToday.where((a) => a['status'] == 'completed').length;
              ...
              return Padding(
                ...
                child: Column(
                  children: [
                    ...
                    // ── Stats Row ──────────────────
                    _StatsRow(
                      todayCount: _todayCountTotal,
                      emergencyCount: _emergencyCountTotal,
                      completedCount: _completedTodayCount,
                      isMobile: isMobile,
                    ),
                    SizedBox(height: isMobile ? AppSpacing.md : AppSpacing.lg),
