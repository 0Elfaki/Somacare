...
('Pulse Oximeter', 'Fingertip pulse oximeter for SpO2 and pulse rate.', 24.99, 29.99, 'personalCare', true, 4.7, 198, false, '💗'),

-- Devices (5 products)
('Nebulizer Machine', 'Portable mesh nebulizer for respiratory treatment.', 49.99, 59.99, 'devices', true, 4.8, 89, true, '🌫️'),
